...
var file_npool_cloud_hashing_apis_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x6f, 0x32, 0xca, 0x0b, 0x0a, 0x10, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x48, 0x61, 0x73,
...
var file_npool_cloud_hashing_apis_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
...
var file_npool_cloud_hashing_apis_proto_depIdxs = []int32{
	...
	45, // 32: cloud.hashing.apis.v1.CloudHashingApis.Version:input_type -> google.protobuf.Empty
	11, // 33: cloud.hashing.apis.v1.CloudHashingApis.GetGoodsDetail:input_type -> cloud.hashing.apis.v1.GetGoodsDetailRequest
	9,  // 34: cloud.hashing.apis.v1.CloudHashingApis.GetGoodDetail:input_type -> cloud.hashing.apis.v1.GetGoodDetailRequest
	37, // 35: cloud.hashing.apis.v1.CloudHashingApis.SubmitOrder:input_type -> cloud.hashing.apis.v1.SubmitOrderRequest
	40, // 36: cloud.hashing.apis.v1.CloudHashingApis.CreateOrderPayment:input_type -> cloud.hashing.apis.v1.CreateOrderPaymentRequest
	28, // 37: cloud.hashing.apis.v1.CloudHashingApis.GetOrderDetail:input_type -> cloud.hashing.apis.v1.GetOrderDetailRequest
	30, // 38: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersDetailByAppUser:input_type -> cloud.hashing.apis.v1.GetOrdersDetailByAppUserRequest
	32, // 39: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersDetailByApp:input_type -> cloud.hashing.apis.v1.GetOrdersDetailByAppRequest
	34, // 40: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersDetailByGood:input_type -> cloud.hashing.apis.v1.GetOrdersDetailByGoodRequest
	42, // 41: cloud.hashing.apis.v1.CloudHashingApis.Signup:input_type -> cloud.hashing.apis.v1.SignupRequest
	1,  // 42: cloud.hashing.apis.v1.CloudHashingApis.Version:output_type -> cloud.hashing.apis.v1.VersionResponse
	12, // 43: cloud.hashing.apis.v1.CloudHashingApis.GetGoodsDetail:output_type -> cloud.hashing.apis.v1.GetGoodsDetailResponse
	10, // 44: cloud.hashing.apis.v1.CloudHashingApis.GetGoodDetail:output_type -> cloud.hashing.apis.v1.GetGoodDetailResponse
	39, // 45: cloud.hashing.apis.v1.CloudHashingApis.SubmitOrder:output_type -> cloud.hashing.apis.v1.SubmitOrderResponse
	41, // 46: cloud.hashing.apis.v1.CloudHashingApis.CreateOrderPayment:output_type -> cloud.hashing.apis.v1.CreateOrderPaymentResponse
	29, // 47: cloud.hashing.apis.v1.CloudHashingApis.GetOrderDetail:output_type -> cloud.hashing.apis.v1.GetOrderDetailResponse
	31, // 48: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersDetailByAppUser:output_type -> cloud.hashing.apis.v1.GetOrdersDetailByAppUserResponse
	33, // 49: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersDetailByApp:output_type -> cloud.hashing.apis.v1.GetOrdersDetailByAppResponse
	35, // 50: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersDetailByGood:output_type -> cloud.hashing.apis.v1.GetOrdersDetailByGoodResponse
	44, // 51: cloud.hashing.apis.v1.CloudHashingApis.Signup:output_type -> cloud.hashing.apis.v1.SignupResponse
